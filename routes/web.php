...
/* Route::get('/datos', function () {
    return view('certificados.usuarios.datos');
});
*/
/* Route::get('/datos1', function () {
    return view('certificados.usuarios.certificadopdf');
});
 */
...
Route::get('/certificadodowload/pdf/{idcurso}/{idcolegiado}', [MatriculaController::class, 'certificadoPDF'])->name('certificadopdf');

Route::get('/certificado/pdf/{idcurso}/{idcolegiado}', [MatriculaController::class, 'certificadodatos'])->name('certificadopdatos');
